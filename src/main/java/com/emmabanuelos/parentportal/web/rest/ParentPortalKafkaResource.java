...
import com.emmabanuelos.parentportal.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/parent-portal-kafka")
public class ParentPortalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ParentPortalKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public ParentPortalKafkaResource(KafkaProperties kafkaProperties) {
