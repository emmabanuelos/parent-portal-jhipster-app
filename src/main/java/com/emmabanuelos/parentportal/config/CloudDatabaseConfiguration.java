...
@Configuration
@EnableReactiveMongoRepositories("com.emmabanuelos.parentportal.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.emmabanuelos.parentportal.config.dbmigrations");
